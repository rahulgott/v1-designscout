...
function useCallback(arg0: (event: any) => void, arg1: (import("react").Dispatch<import("react").SetStateAction<boolean>> | import("react").Dispatch<import("react").SetStateAction<string>>)[]) {
