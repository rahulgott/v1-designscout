...
export default function ViewComment({index, data}: {index: number, data: any}) {
        const [openCrudOptions, setOpenCrudOptions] = useState(false)

        const {showInputOnClick, setViewCommentOnClick} = useDraggableArea()
        ...
        return (
                <div className={styles.viewComment}>
                        <div className={styles.topBar}>
                                <p>Your response</p>
                                <svg onClick={() => setOpenCrudOptions(!openCrudOptions)} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        {openCrudOptions && (<div className={styles.crudOptions}>
