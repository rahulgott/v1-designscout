...
export default function CandidateInterface() {
  ...
  const mockData: MockData = {
    ...
    questions: [
      ...
      {
        question: "Question 3?",
        imageMockup: "https://play-lh.googleusercontent.com/z1ynNM1nPd7JOOGYRK16qcrX7KZpK0CrnNUUyQXOCxfuxtVcA5lu3qPKWK7ZR_Pp4Q",
      }
    ],
    comments: []
  }
  ...
  return (
    ...
    */}
      ...
      <LeftNav questions={mockData.questions} productBrief={mockData.productBrief}/>
      <InstructionsNav /> 
      <Timer timerMinutes={mockData.timeLimit}/>
      <CommentNav />
      <ToolBarNav />
      <CanvasArea imageMockup={mockData.questions[currentQuestion].imageMockup} />
    </div>
  )
}
